...
public class PostlistAdapter extends RecyclerView.Adapter<PostlistAdapter.PostlistViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PostlistViewHolder postlistViewHolder, int position) {
        ...
        //Ab humesuppose 0th position waali image nikalni hain toh hum elements mein se 0th pos
        //nikalenge aur uska attribute nikaalenge (image mein src hota hain) isse hume 0th image ki URL milegi
        Log.d("CODE", "Image = "+elements.get(0).attr("src"));
        //Jo bhi attribute chahiye wo nikaal saktein hain jaise width etc

        //Agar hume pure HTML document mein koi TAG nahin chahiye sirf text xhahiye to tet property use karenge
